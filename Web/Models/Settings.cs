namespace Web.Models
{
    public static class Settings
    {
        ...
        public const string Description = "Independent contractor and software consultant based in Ithaca, NY; working remotely with teams and businesses everywhere";
