...
namespace VTSV.EXIF
{
    ...
    /// 
    /// </summary>
    public sealed class EXIFextractor : IEnumerable
    {
        /// <summary>
        ...
        /// <returns></returns>
        static int convertToInt32(IList<byte> arr)
        {
            if (arr.Count != 4)
                return 0;
        ...
        /// <param name="arr"></param>
        /// <returns></returns>
        static uint convertToInt32U(IList<byte> arr)
        {
            return arr.Count != 4 ? 0 : Convert.ToUInt32(arr[3] << 24 | arr[2] << 16 | arr[1] << 8 | arr[0]);
        }
        ...
        /// <param name="arr"></param>
        /// <returns></returns>
        static uint convertToInt16U(IList<byte> arr)
        {
            return Convert.ToUInt16(arr.Count != 2 ? 0 : arr[1] << 8 | arr[0]);
        }
